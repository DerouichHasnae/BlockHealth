...
import { FiHome, FiUser, FiUsers, FiSettings, FiLogOut, FiCalendar, FiClock } from "react-icons/fi";
        ...
        <ul className="sidebar-menu">
          ...
          <li className="menu-item">
            <a
              ...
              onClick={() =>
                handleNavigation(
                  `/availability/${doctorDetails ? doctorDetails[6].toLowerCase() : "cardiologie"}`,
                  "availability"
                )
              }
            >
          ...
          <li className="menu-item">
            <a
              className={`menu-link ${activeMenu === "appointments" ? "active" : ""}`}
              onClick={() => handleNavigation(`/doctor/${hhNumber}/appointments`, "appointments")}
            >
          ...
          {doctorDetails && (
            <>
              <h1 className="welcome-title">
                Welcome back, <span className="doctor-name">Dr. {doctorDetails[1]}</span>
              </h1>
